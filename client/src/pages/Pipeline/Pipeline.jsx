...
const Pipeline = () => {
    ...
    const handleDrop = (e, stageKey) => {
        e.preventDefault()
        if (draggedApp) {
            handleStatusChange(draggedApp._id, stageKey)
        }
        setDraggedApp(null)
        setDragOverStage(null)
    }
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
                <div>
                    ...
                    <p style={{ color: "#64748b", fontSize: "14px" }}>
                        🖱️ Drag candidates to move stages · AI-ranked candidates across hiring stages
                    </p>
                </div>
                <select
                    value={selectedJob}
                    ...
                    {STAGES.map(stage => {
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    minWidth: "280px", background: isOver ? stage.bg : "#f8fafc",
                                    borderRadius: "16px", padding: "16px",
                                    border: isOver ? `2px dashed ${stage.color}` : "1px solid #e2e8f0",
                                    transition: "all 0.2s ease",
                                    boxShadow: isOver ? `0 0 0 3px ${stage.color}20` : "none"
                                }}
                            >
                                {/* Stage header */}
                                    ...
                                    {stageApps.map(app => (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                cursor: "grab",
                                                opacity: draggedApp?._id === app._id ? 0.5 : 1,
